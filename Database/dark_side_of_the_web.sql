...
--
-- Host: localhost
-- Generation Time: Jul 22, 2024 at 10:16 AM
...
--
-- Database: `dark_side_of_the_web`
--
CREATE DATABASE IF NOT EXISTS `dark_side_of_the_web` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dark_side_of_the_web`;
...
('48nz1cqiw9tvaiunum2o5cvwjgpdggai', 'eyJ1c2VyaWQiOjJ9:1qqBFb:Ifi0SXuwqDUvQm0eOsYp8sXXVMmOrhOe-8ShH-fOCas', '2023-10-24 11:50:12.041801'),
...
('amrgjvpebgpe0zriw4hpttkhsjwzn2xe', 'eyJ1c2VyaWQiOjF9:1oYPgL:WYtKTH_wYINNeXvB4a8O4T-va8TBm-_RPm2w6Y9xYD0', '2022-09-28 10:31:49.961847'),
...
('g7nuag90xjhnh9u95i20nypedy1z6qdq', 'eyJ1c2VyaWQiOjN9:1oYRqG:HUdDJ2Z2-FYWfKfiOCzL3k5yQ_OS4o68mpY6iJv1KuE', '2022-09-28 12:50:12.946037'),
('g8kksqfchjis8kcs2kwuxz9p8os00sra', 'eyJ1c2VyaWQiOjF9:1qq9oA:iYscmnTUU4BThxhtw-iBwzQ6mOOQrgdMnk5Ez_OUvlc', '2023-10-24 10:17:46.415956'),
...
('lp85tgyisk2yigrd43iytmf1610q68aq', 'eyJ1c2VyaWQiOjF9:1sVmgz:bKvP812bZSTdd0kgfZq54eT2NeWwIXvz01SOL6WgUnQ', '2024-08-05 06:38:41.645777'),
...
('z0uj1r2lo3u8tna25h58o96x2kzmwvn7', 'eyJ1c2VyaWQiOjN9:1sVq12:o4j9bjpMfEBtSDZFckWeoLsb-EenB7u29lB5XH3J0aQ', '2024-08-05 10:11:36.028137'),
...
(3, 'tmksmanju', 'tmksmanju13@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(31, 'Convolutional Neural Network---(CNN)', '51.55038759689923'),
(32, 'SVM', '50.0'),
(33, 'Logistic Regression', '48.44961240310077'),
(34, 'Gradient Boosting Classifier', '50.0'),
(35, 'Random Forest Classifier', '52.71317829457365');
...
(8, 'Threat Found', '66.66666666666666'),
(9, 'Threat Not Found', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_web_classification`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_web_classification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `Protocol` varchar(3000) NOT NULL,
  `Flag` varchar(3000) NOT NULL,
  `Packet` varchar(3000) NOT NULL,
  `Sender_ID` varchar(3000) NOT NULL,
  `Receiver_ID` varchar(3000) NOT NULL,
  `Source_IP_Address` varchar(3000) NOT NULL,
  `Destination_IP_Address` varchar(3000) NOT NULL,
  `Source_Port` varchar(3000) NOT NULL,
  `Destination_Port` varchar(3000) NOT NULL,
  `Packet_Size` varchar(3000) NOT NULL,
...
--
-- Dumping data for table `remote_user_predict_web_classification`
--

INSERT INTO `remote_user_predict_web_classification` (`id`, `Fid`, `Protocol`, `Flag`, `Packet`, `Sender_ID`, `Receiver_ID`, `Source_IP_Address`, `Destination_IP_Address`, `Source_Port`, `Destination_Port`, `Packet_Size`, `Prediction`, `Url`) VALUES
(1, '10.152.152.11-10.152.152.10-52278-53-17', 'UDP', 'ACK', 'SNMP', '456789', '234567', '10.0.0.8', '192.168.0.5', '161', '12345', '768', 'Threat Found', 'https://wzplh.app.link/e2WxrTBLm4\r\n'),
(2, '10.152.152.11-10.152.152.10-50702-53-17', 'UDP', 'ACK', 'NTP', '987654', '123456', '192.168.0.1', '10.0.0.5', '12345', '123', '512', 'Threat Not Found', 'http://hostpoint.ch.gbp-events.com.prunauneau.fr/943070958193827623/\r\n'),
(3, '10.152.152.11-10.152.152.10-42552-53-17', 'UDP', 'ACK', 'NTP', '987654', '123456', '192.168.0.1', '10.0.0.5', '12345', '123', '512', 'Threat Found', 'https://drive.google.com/file/d/1QF58H-1LUNq1PubplWDhwd3UOOj_VjxA/view\r\n');
