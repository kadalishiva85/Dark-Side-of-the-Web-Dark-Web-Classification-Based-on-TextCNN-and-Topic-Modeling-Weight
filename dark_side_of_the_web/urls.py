"""dark_side_of_the_web URL Configuration
...
from dark_side_of_the_web import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Web_Classification_Type/$', remoteuser.Predict_Web_Classification_Type, name="Predict_Web_Classification_Type"),
    ...
    url(r'^View_Predicted_Web_Classification_Type_Ratio/$', serviceprovider.View_Predicted_Web_Classification_Type_Ratio, name="View_Predicted_Web_Classification_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Web_Classification_Details/$', serviceprovider.View_Prediction_Web_Classification_Details, name="View_Prediction_Web_Classification_Details"),
