...
def Predict_Web_Classification_Type(request):
    if request.method == "POST":
        ...
        predict_web_classification.objects.create(
        Fid=Fid,
        Protocol=Protocol,
        Flag=Flag,
        Packet=Packet,
        ...
        return render(request, 'RUser/Predict_Web_Classification_Type.html',{'objs': val})
    return render(request, 'RUser/Predict_Web_Classification_Type.html')
